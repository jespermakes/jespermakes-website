...
async function Header() {
  ...
  return (
    <header className="border-b border-cream/10 bg-[#20100A]">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-sans">
          ...
          <div className="relative group">
            ...
            <div className="absolute top-full left-1/2 -translate-x-1/2 pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-150 z-50">
              <div className="bg-[#2A1712] border border-cream/10 rounded-xl shadow-lg py-2 w-52">
                {[
                  ...
                  <Link
                    ...
                    className="flex items-center gap-2.5 px-4 py-2 text-sm text-cream/70 hover:text-amber hover:bg-cream/5 transition-colors"
                  >
          ...
          <div className="relative group">
            <span className="text-cream/70 hover:text-amber transition-colors cursor-pointer">
              Apps
            </span>
            <div className="absolute top-full left-1/2 -translate-x-1/2 pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-150 z-50">
              <div className="bg-[#2A1712] border border-cream/10 rounded-xl shadow-lg py-2 w-52">
                ...
                <div className="my-1 mx-3 h-px bg-cream/10" />
                <Link
                  href="/title-lab"
                  className="flex items-center gap-2.5 px-4 py-2 text-sm text-cream/70 hover:text-amber hover:bg-cream/5 transition-colors"
                >
