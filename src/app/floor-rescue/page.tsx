...
export default function FloorRescuePage() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-14">
      ...
      <p className="text-wood-light/70 text-lg leading-relaxed mb-8 max-w-[620px]">
        Worst floor wins. Three worn wooden floors get rescued by their owners, with the oil to do it.
      </p>

      <div className="text-wood-light/80 text-[15px] leading-relaxed max-w-[620px] space-y-4 mb-10">
        <p>
        ...
        <p>
          ...
          <a href="/rubio" className="text-[#C17F3C] underline decoration-wood-light/30 hover:decoration-[#C17F3C]">
            the Rubio guide
          </a>
          .
        </p>
      ...
      <p className="text-xs text-wood-light/40 mt-10 max-w-2xl leading-relaxed">
