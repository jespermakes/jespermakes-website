...
export const metadata: Metadata = {
  title: "Get in touch | Jesper Makes",
  description:
        ...
        <div className="space-y-12">
          <section>
            ...
            <a
              ...
              className="inline-block text-forest hover:text-forest-dark font-medium transition-colors text-lg"
            >
          ...
          <section>
            ...
            <div className="mt-4">
              <Link
                href="/sponsors"
                className="text-wood-light/60 hover:text-forest text-sm transition-colors"
              >
          ...
          <section>
            ...
            <div className="flex flex-wrap items-center gap-4">
              <a
                href="mailto:hello@jespermakes.com"
                className="inline-block text-forest hover:text-forest-dark font-medium transition-colors"
              >
                hello@jespermakes.com
              </a>
            </div>
            <div className="flex flex-wrap gap-3 mt-4">
              <Link
                href="/press-kit"
                className="inline-block border border-wood/20 hover:border-forest text-wood px-4 py-2 rounded-lg text-sm font-medium transition-colors"
              >
          ...
          <div className="bg-wood/5 rounded-xl p-8">
            ...
            <div className="space-y-4">
              <a
                ...
                className="flex items-center gap-3 text-wood-light hover:text-forest transition-colors group"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814ZM9.545 15.568V8.432L15.818 12l-6.273 3.568Z"/></svg>
                <span className="font-medium">YouTube</span>
                <span className="text-wood-light/40 text-sm">357K subscribers</span>
              </a>
              <a
