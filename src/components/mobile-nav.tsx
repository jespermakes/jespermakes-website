  ...
  return (
    <div className="md:hidden">
      ...
      <button
        ...
        className="text-wood-light hover:text-forest transition-colors p-2 -mr-2"
          ...
          <nav className="px-6 py-6 space-y-1 overflow-y-auto max-h-[calc(100vh-80px)]">
              ...
              {toolsOpen && (
                <div className="pb-3 pl-2 space-y-1">
                  <Link
                    href="/tools"
                    onClick={() => setOpen(false)}
                    className="block py-2 text-sm font-medium text-forest"
                  >
                    All Tools
                  </Link>
                  {toolCategories.map((cat) => (
                    <Link
                      ...
                      onClick={() => setOpen(false)}
                      className="flex items-center gap-2.5 py-2 text-sm text-wood-light hover:text-forest transition-colors"
                    >
                      <span>{cat.icon}</span>
                      {cat.title}
                    </Link>
            ...
            {userName ? (
              <Link
                href="/account"
                onClick={() => setOpen(false)}
                className="block py-3 text-lg text-forest font-medium border-b border-wood/5"
              >
                {userName}
              </Link>
            ) : (
